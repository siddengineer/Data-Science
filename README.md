...
LATEST UPLOAD:
H1-B VISA DATA SCIENCE PROJECT:https://github.com/siddengineer/Data-Science/blob/main/H%20B-1%20VISA%20DATA%20SCIENCE.pdf
...
|-----|--------------------------------|------------------|-----------------------------------------------------------------|----------------------|
| 1   | 🛒 Retail & E-Commerce          | Amazon           | Predict product return likelihood based on order patterns.      | https://github.com/siddengineer/Data-Science/blob/main/Untitled12.ipynb       |
...
| 10   | Online Shoppers Intention Dataset   | E-Commerce Prediction             | [Link]()            |
...
| 7   | numpy_eye_identity_matrix.py                    |                              |
| 8   | numpy_random_array.py                            |                              |
| 9   | numpy_full_constant_array.py                     |                              |
| 10  | numpy_dtype_example.py                           |                              |
| 11  | array_addition.py                               |                              |
| 12  | array_subtraction.py                            |                              |
| 13  | array_multiplication.py                          |                              |
| 14  | array_division.py                               |                              |
| 15  | elementwise_vs_matrix_multiplication.py         |                              |
| 16  | broadcasting_demo.py                             |                              |
| 17  | numpy_reshape_example.py                          |                              |
| 18  | numpy_flatten_ravel.py                           |                              |
| 19  | numpy_transpose_example.py                        |                              |
| 20  | numpy_concatenate_stack.py                        |                              |
| 21  | array_indexing_basic.py                           |                              |
| 22  | array_slicing_rows_cols.py                        |                              |
| 23  | boolean_indexing.py                               |                              |
| 24  | fancy_indexing.py                                 |                              |
| 25  | conditional_selection.py                          |                              |
| 26  | numpy_mean_median_mode.py                          |                              |
| 27  | numpy_sum_min_max.py                               |                              |
| 28  | numpy_argmin_argmax.py                              |                              |
| 29  | numpy_std_variance.py                               |                              |
| 30  | numpy_percentile_quantile.py                         |                              |
| 31  | numpy_dot_product.py                                 |                              |
| 32  | numpy_matrix_inverse.py                               |                              |
| 33  | numpy_determinant.py                                   |                              |
| 34  | numpy_eigenvalues_vectors.py                            |                              |
| 35  | numpy_solve_linear_equations.py                           |                              |
| 36  | numpy_random_uniform.py                                   |                              |
| 37  | numpy_random_normal.py                                    |                              |
| 38  | numpy_random_choice.py                                     |                              |
| 39  | numpy_random_seed.py                                        |                              |
| 40  | numpy_random_shuffle_permutation.py                           |                              |
| 41  | numpy_where_example.py                                       |                              |
| 42  | numpy_unique_example.py                                       |                              |
| 43  | numpy_sort_argsort.py                                         |                              |
| 44  | numpy_stack_split.py                                          |                              |
| 45  | numpy_tile_repeat.py                                         |                              |
| 46  | numpy_cumsum_cumprod.py                                      |                              |
| 47  | numpy_meshgrid_example.py                                     |                              |
| 48  | numpy_diag_trace.py                                          |                              |
| 49  | numpy_save_load_npy.py                                       |                              |
| 50  | numpy_loadtxt_genfromtxt_csv.py                                |                              |
